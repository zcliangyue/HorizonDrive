...
def _video_vae(z_dim=None, temperal_downsample=[False, True, True], temporal_compression_ratio=4, **kwargs):
    """
...
class AutoencoderKLWan(ModelMixin, ConfigMixin, FromOriginalModelMixin):
    ...
    def __init__(
        ...
        elif temporal_compression_ratio == 2:
            temperal_downsample = [False, False, True]
        else:
            raise NotImplementedError(
                "Only temporal_compression_ratio 1, 2 and 4 are supported."
            )
