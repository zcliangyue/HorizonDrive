...
class Config:
    ...
    Example:
        ...
        >>> cfg.filename
        "/path/to/tests/data/config/a.py"
        >>> cfg.item4
        'test'
        >>> cfg
        "Config [path: /path/to/tests/data/config/a.py]: "
    ...
    def to_omegaconf(self):
        return OmegaConf.create(self._cfg_dict.to_dict())
...
if __name__ == "__main__":
    cfg = Config.fromfile("../../config/wan_unified/wan_unified_i2v.yaml")
    print(cfg)
    print(type(cfg))